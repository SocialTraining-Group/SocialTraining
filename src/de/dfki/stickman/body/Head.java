...
public class Head extends BodyPart {
	...
	GeneralPath mHead, mLeftEar, mRightEar, mFemaleHair, mMaleHair, mNose, leftCheek, rightCheek;
	...
	public Point getNeckStartPosition() {
        ...
        {
            return new Point(mHalfWidth+5, mHalfHeight);
        }
        
        public Point getNoseMiddlePosition()
        {
            return new Point(mHalfHeight+12, mHalfHeight + 15);
        }
        
        public Point getNoseEndPosition()
        {
            return new Point(mHalfHeight+20, mHalfHeight + 12);
        }
	...
	public void calculate(int step) {
		...
		mHead.transform(t);
                ...
                //nose
                mNose = new GeneralPath();
                mNose.moveTo(mHalfWidth+5, mHalfHeight);
                mNose.lineTo(mHalfHeight+12, mHalfHeight + 15);
//                mNose.lineTo(mHalfHeight+17, mHalfHeight + 12);
                mNose.curveTo(mHalfHeight+12, mHalfHeight + 15, mHalfHeight+15, mHalfHeight + 20, mHalfHeight+20, mHalfHeight + 12);
